...
export const PointManagement = ({ 
  ...
  const handleEdit = async () => {
    ...
    console.log('editingAdjustment:', editingAdjustment);
    console.log('onEditPointAdjustment:', !!onEditPointAdjustment);
    
    if (!editingAdjustment || !onEditPointAdjustment) {
      console.log('Missing editingAdjustment or onEditPointAdjustment');
      return;
    }
    
    const points = parseInt(adjustPoints);
    console.log('points:', points, 'adjustPoints:', adjustPoints);
    ...
    console.log('Calling onEditPointAdjustment with:', { id: editingAdjustment.id, points: actualPoints, reason: adjustReason.trim() });
    const success = await onEditPointAdjustment(editingAdjustment.id, actualPoints, adjustReason.trim());
    console.log('onEditPointAdjustment returned:', success);
    setIsSubmitting(false);
